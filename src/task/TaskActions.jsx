  ...
  return (
    <div className="mb-14 items-center justify-between sm:flex">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-red-500 to-red-600 px-5 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2" onClick={onDeleteAllClick}>
